...
\setmonofont{Inconsolata}[Path = /project/resources/fonts/Inconsolata/, Extension = .ttf, Scale=0.9, UprightFont = *-Regular, BoldFont = *-Bold]
\usepackage {titlesec}
...
\subsection{Benefits}
\label{sec:org5022183}
\subsubsection{General}
\label{sec:org774961e}
\begin{itemize}
...
\label{sec:org90de67c}
\subsubsection{General}
\label{sec:org7dd6587}
\begin{itemize}
...
\label{sec:org15f6c5d}

\subsection{Objectives}
\label{sec:org4f8d712}
...
\section{Appendix}
\label{sec:org5abec62}
\sffamily  
\setlength{\parindent}{0em}    
\subsection{Development Environment}
\label{sec:orgc18f3a3}
...
\label{sec:orgf48a0e7}

\subsubsection{Font definitions}
\label{sec:org89b8720}
\setlength{\parindent}{0em}  
