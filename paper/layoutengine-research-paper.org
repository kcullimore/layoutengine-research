...
- Web browsers are sophisticated layout and rendering engines and are continually being updated to support the latest web standards
...
- Web Browser Interface
  ...
  - Two-way Communication between R and the browser
...
The focus of the subject research focuses primarily on developing some alternatives the preexisting layoutEngine Backends. Two newly developed layoutEngine Backends attempt to incorporate a *Target Feature Set* that were identified as being paramount to the needs of a production ready solution. One of these Backends relies on a *[[https://www.selenium.dev/documentation/en/][Selenium]]* server hosted within a *[[https://www.docker.com/resources/what-container][Docker container]]* container. The second Backend is a custom *[[https://www.docker.com/resources/what-container][NodeJS]]* server also hosted within a Docker container. 
...
- Bi-directional Communication:
  - The R httpuv package is also used to create a Web Socket server which creates a bi-directional communication protocol with the local default browser. 
